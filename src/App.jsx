...
function App() {
  ...
  return (
  <div
    className="relative flex w-full min-h-screen flex-col bg-white group/design-root overflow-x-hidden"
    style={{ fontFamily: 'Inter, "Noto Sans", sans-serif' }}
  >
    <div className="layout-container flex h-full grow flex-col">
      <header className="HeadMenu">
        <div className="HeaderMenuSubLogoAndText">
          <div className="SizeSvg" style={{marginRight:"10px"}}>
        ...
        <div className="AllBody2">
          <div className="ContainerIm">
            <div className="ContainerImNd">
              ...
              >
                ...
                <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 @[480px]:h-12 @[480px]:px-5 bg-[#0c7ff2] text-white text-sm font-bold leading-normal tracking-[0.015em] @[480px]:text-base">
          ...
          <div className="AboutUs">
            <div className="AboutUsHowWork">
              <h1 className="text-[#111418] tracking-light text-[32px] font-bold leading-tight @[480px]:text-4xl max-w-[720px]">
                How it works
              </h1>
